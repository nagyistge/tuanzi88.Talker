...
namespace Apple
{
    public class NamedColorGroup
    {
        // Instance members.
        private NamedColorGroup()
        {
        }
        ...
        static NamedColorGroup()
        {
                ...
                typeof (NamedColorGroup).GetRuntimeFields ())
            {
                    ...
                    fieldInfo.FieldType == typeof (Color))
                {
                    ...
                    NamedColorGroup namedColor = new NamedColorGroup
                        {
                            Name = name,
        ...
        public static IEnumerable<NamedColorGroup> All { private set; get; }
